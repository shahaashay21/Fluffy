...
public class CommConnection {
	...
	LinkedBlockingDeque<GlobalMessage> outbound;
	 ...
	 * @return
	 */
	public boolean write(GlobalMessage msg) {
		if (msg == null)
			return false;
	...
	private void init() {
		...
		outbound = new LinkedBlockingDeque<GlobalMessage>();
	...
	/**
	*to return channel for a particular instance
	*/
	...
	/**
	*to return host address for this instance
	*/
	...
	/**
	*to return post address for this instance
	*/
	public int getPort(){
		return this.port;
	}
