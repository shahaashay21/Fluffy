...
PROTOC_HOME=/usr/local/Cellar/protobuf260/2.6.0
...
$PROTOC_HOME/bin/protoc --proto_path=${project_base}/resources --java_out=${project_base}/generated ${project_base}/resources/storage.proto
